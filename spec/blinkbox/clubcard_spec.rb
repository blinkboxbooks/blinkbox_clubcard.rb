...
describe Blinkbox::Clubcard do
  ...
  describe "#generate_random" do
    it "should return a UK Clubcard by default" do
      expect(described_class.generate_random).to be_instance_of(Blinkbox::Clubcard::UK)
    end

    it "should be able to generate a UK Privilege clubcard" do
      expect(described_class.generate_random(type: Blinkbox::Clubcard::UKPrivilege)).to be_instance_of(Blinkbox::Clubcard::UKPrivilege)
    end

    it "should be able to generate a UK Student clubcard" do
      expect(described_class.generate_random(type: Blinkbox::Clubcard::UKStudent)).to be_instance_of(Blinkbox::Clubcard::UKStudent)
    end
  end
end
